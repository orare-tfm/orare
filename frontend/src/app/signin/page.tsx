          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            ...
            <div>
              <button
                ...
                className="disabled:opacity-40 flex w-full justify-center rounded-md bg-cyan-600 text-gray-100 px-3 py-1.5 text-sm font-semibold leading-6 text-gray-400 shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Ingresar
              </button>
            </div>
